...
_FAMILY_CMAP = {
    ...
    ("error", "value"): "Reds",
    ("error", "pvalue"): "Reds_r",
    ("sensitive", "value"): "Purples",
    ("sensitive", "pvalue"): "Purples_r",
    ("meta", "value"): "Greys",
    ("meta", "pvalue"): "Greys_r",
}
...
def classify_column(col, error_label="error", sensitive_labels=None):
    ...
    if col.startswith("error="):
        ...
        rest = col[len("error=") :]
        for suf, kind, lbl in (
            ("_gap_sig", "pvalue", " gap sig."),
            ("_gap_class", "category", " gap class"),
            ("_gap_cat", "category", " gap cat."),
            ("_sep", "pvalue", " sep."),
            ("_gap", "value", " gap"),
            ("_cat", "category", " cat."),
        ):
